...
public class SearchEngineTest
{
	...
	{
		addFood();
		assertEquals(Arrays.asList(SPAGHETTI_ID, TOMATO_SAUCE_ID), searchEngine.relevanceLookup("pasta"));
	}
	...
	{
		addFood();
		assertEquals(Arrays.asList(WAT_ID, CHOW_MEIN_ID), searchEngine.relevanceLookup("beef"));
	}
	...
	{
		addFood();
		assertEquals(Arrays.asList(), searchEngine.relevanceLookup("foobar"));
	}
}